...
export default function QuizPreview() {
  ...
  if (!isFaculty) {
    return <div className="p-4">Access denied. Only faculty can preview quizzes.</div>;
  }
    ...
    return (
      <div style={{ backgroundColor: "#f5f5f5", minHeight: "100vh", padding: "20px" }}>
        <div style={{ backgroundColor: "white", borderRadius: "8px", padding: "20px", maxWidth: "800px", margin: "0 auto" }}>
          ...
          {/* Quiz Title */}
          <h2 className="mb-3">{currentQuiz.title} - Preview Results</h2>
          ...
          <div className="text-center mt-4">
            <Button variant="outline-secondary" onClick={() => setIsCompleted(false)} className="me-2">
              Retake Preview
            </Button>
